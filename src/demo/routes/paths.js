...
const ROOTS_DASHBOARD = '/demos';
const ROOTS_LEARN = '/learn';
const ROOTS_TEACH = '/teach';
...
export const PATH_DASHBOARD = {
  ...
  learn: {
    ...
    dashboard: path(ROOTS_DASHBOARD, '/learn/application'),
    catalog: path(ROOTS_DASHBOARD, '/learn/catalog')
  },
  teach: {
    root: path(ROOTS_DASHBOARD, '/'),
    dashboard: path(ROOTS_DASHBOARD, '/teach/application')
  },
