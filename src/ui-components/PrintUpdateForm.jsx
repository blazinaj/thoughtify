...
export default function PrintUpdateForm(props) {
  const {
    id: idProp,
    print: printModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = printRecord
      ? { ...initialValues, ...printRecord }
      : initialValues;
    setName(cleanValues.name);
    setDescription(cleanValues.description);
    setPrintDateTime(cleanValues.printDateTime);
    setPrintCost(cleanValues.printCost);
    setPrintCostCurrency(cleanValues.printCostCurrency);
    setPrintCostNotes(cleanValues.printCostNotes);
    setPrintNotes(cleanValues.printNotes);
    setPrintPhotos(cleanValues.printPhotos ?? []);
  ...
  const [printRecord, setPrintRecord] = React.useState(printModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Print, idProp)
        : printModelProp;
      setPrintRecord(record);
    };
    queryData();
  }, [idProp, printModelProp]);
  React.useEffect(resetStateValues, [printRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Print.copyOf(printRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "PrintUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || printModelProp)}
