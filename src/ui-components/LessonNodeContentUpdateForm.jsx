...
export default function LessonNodeContentUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = lessonNodeContentRecord
      ? { ...initialValues, ...lessonNodeContentRecord }
      : initialValues;
  ...
  const [lessonNodeContentRecord, setLessonNodeContentRecord] = React.useState(
    lessonNodeContentModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(LessonNodeContent, idProp)
        : lessonNodeContentModelProp;
