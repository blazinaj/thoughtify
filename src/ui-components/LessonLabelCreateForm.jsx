...
export default function LessonLabelCreateForm(props) {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const lessonLabel = await DataStore.save(new LessonLabel(modelFieldsToSave));
          const promises = [];
          promises.push(
      ...
      {...getOverrideProps(overrides, 'LessonLabelCreateForm')}
      {...rest}
    >
      <TextField
        label="Name"
