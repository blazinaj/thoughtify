...
export default function EnrollmentTopicProgressCreateForm(props) {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new EnrollmentTopicProgress(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, 'EnrollmentTopicProgressCreateForm')}
      {...rest}
    >
      <SelectField
        label="Status"
