...
export default function TokenTransactionUpdateForm(props) {
  ...
  const [tokenTransactionRecord, setTokenTransactionRecord] = React.useState(
    tokenTransactionModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(TokenTransaction, idProp)
        : tokenTransactionModelProp;
      setTokenTransactionRecord(record);
      const tokenwalletIDRecord = record
        ? await record.tokenwalletID
        : undefined;
