...
export default function LessonNodeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setLessonNodeContent(initialValues.LessonNodeContent);
    setCurrentLessonNodeContentValue(undefined);
    setCurrentLessonNodeContentDisplayValue("");
    setLessonNodeQuiz(initialValues.LessonNodeQuiz);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LessonNode(modelFieldsToSave));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LessonNodeCreateForm")}
      {...rest}
    >
      <ArrayField
        lengthLimit={1}
