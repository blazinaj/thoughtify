...
export default function PostCommentUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = postCommentRecord
      ? { ...initialValues, ...postCommentRecord, userID, postID }
      : initialValues;
  ...
  const [postCommentRecord, setPostCommentRecord] =
    React.useState(postCommentModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(PostComment, idProp)
        : postCommentModelProp;
