...
export default function LessonCategoryUpdateForm(props) {
  ...
  const [lessonCategoryRecord, setLessonCategoryRecord] = React.useState(
    lessonCategoryModelProp
  );
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(LessonCategory, idProp)
        : lessonCategoryModelProp;
          ...
          lessonsToUnLinkMap.forEach(async (count, id) => {
            ...
            const lessonLessonCategoryRecords = await DataStore.query(
              ...
              (r) =>
                r.and((r) => {
                  return [
                    r.lessonID.eq(recordKeys.id),
                    r.lessonCategoryID.eq(lessonCategoryRecord.id),
                  ];
                })
            );
