...
export declare type FilamentUpdateFormInputValues = {
    name?: string;
    description?: string;
    color?: string;
    weight?: number;
...
export declare type FilamentUpdateFormValidationValues = {
...
export declare type FilamentUpdateFormOverridesProps = {
    FilamentUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type FilamentUpdateFormProps = React.PropsWithChildren<{
    overrides?: FilamentUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    filament?: Filament;
    onSubmit?: (fields: FilamentUpdateFormInputValues) => FilamentUpdateFormInputValues;
    onSuccess?: (fields: FilamentUpdateFormInputValues) => void;
    onError?: (fields: FilamentUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: FilamentUpdateFormInputValues) => FilamentUpdateFormInputValues;
    onValidate?: FilamentUpdateFormValidationValues;
} & React.CSSProperties>;
export default function FilamentUpdateForm(props: FilamentUpdateFormProps): React.ReactElement;
