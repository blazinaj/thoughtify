...
export default function LessonReviewCreateForm(props) {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LessonReview(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, 'LessonReviewCreateForm')}
      {...rest}
    >
      <ArrayField
        lengthLimit={1}
