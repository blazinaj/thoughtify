...
export default function FilamentCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCostCurrency(initialValues.costCurrency);
    setCostPerWeight(initialValues.costPerWeight);
    setCostPerWeightCurrency(initialValues.costPerWeightCurrency);
    setCostNotes(initialValues.costNotes);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Filament(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FilamentCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
