...
describe(
  'generateThoughtExtracts',
  () => {
    test(
      'should return an object with all the attributes',
      async () => {
    ...
    test(
      'should should remove duplicates',
      async () => {
    ...
    test(
      'should return empty object if no thoughts are provided',
      async () => {
