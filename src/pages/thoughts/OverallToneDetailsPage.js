            ...
            <Container maxWidth={themeStretch ? false : 'lg'}>
                <HeaderBreadcrumbs
                    ...
                    links={[
                        ...
                        {
                            href: `/thoughts/overallTone/${id}`,
                            name: sentenceCase(id)
                        }
                    ]}
                />
                <ThoughtExtractInsight type={'overallTone'} value={id} />
            </Container>
        </Page>
    );
};

export default OverallToneDetailsPage;
