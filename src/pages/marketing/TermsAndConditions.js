      ...
      <ul>
        <li>
          <p>
            ...
            electronic device, named Edify
          </p>
        </li>
        <li>
          <p>
            <strong>Application Store</strong> means the digital distribution service operated and developed by Apple
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Edify
          </p>
        </li>
        <li>
          <p>
